...
// Renderer
//---------
const canvas = document.querySelector(".techno");
...
function add_techno(techno_position_x, techno_name, techno_link, techno_image) {
  ...
  function onMouseMove(event) {
    if (isMouseDown && selectedTechno) {
      ...
      selectedTechno.rotation.y += deltaMove.x * rotationSpeed;
      selectedTechno.rotation.x += deltaMove.y * rotationSpeed;

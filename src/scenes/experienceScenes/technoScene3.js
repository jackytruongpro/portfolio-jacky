...
const canvas = document.querySelector(".technoExperience3");
...
add_techno(-7.5,'Dart', 'https://tickets-siae.com/fr/', '/static/image/techno/logo-html.png');
add_techno(-2.5,'Node', 'https://tickets-siae.com/en/', '/static/image/techno/logo-css.png');
add_techno(2.5,'Node', 'https://tickets-siae.com/en/', '/static/image/techno/logo-vanilla.png');
add_techno(7.5,'Firebase', 'https://tickets-siae.com/fr/', '/static/image/techno/logo-sharepoint.png');

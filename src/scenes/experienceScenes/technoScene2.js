...
const canvas = document.querySelector(".technoExperience2");
...
add_techno(2.5,'Node', 'https://tickets-siae.com/en/', '/static/image/techno/logo-php.png');
add_techno(7.5,'Firebase', 'https://tickets-siae.com/fr/', '/static/image/techno/logo-wordpress.png');

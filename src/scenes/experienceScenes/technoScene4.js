...
const canvas = document.querySelector(".technoExperience4");
...
add_techno(-5,'Dart', 'https://tickets-siae.com/fr/', '/static/image/techno/logo-angular.png');
add_techno(0,'Node', 'https://tickets-siae.com/en/', '/static/image/techno/logo-ts.png');
add_techno(5,'Firebase', 'https://tickets-siae.com/fr/', '/static/image/techno/logo-java.png');
